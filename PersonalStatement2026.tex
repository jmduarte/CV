...
\ifthenelse{\equal{#1}{CMS:2026shw}}{\href{https://arxiv.org/abs/2602.00273}{\textbf{C.2}}}{}%
\ifthenelse{\equal{#1}{Gonski:2026jgu}}{\href{https://arxiv.org/abs/2602.22248}{\textbf{C.3}}}{}%
\ifthenelse{\equal{#1}{CMS:2026yrb}}{\href{https://arxiv.org/abs/2603.22233}{\textbf{C.4}}}{}%
\ifthenelse{\equal{#1}{CMS:2026yvw}}{\href{https://arxiv.org/abs/2603.21965}{\textbf{C.5}}}{}%
...
Finally, the same techniques were applied to search for heavy scalar resonance \PX decaying to a Higgs boson (\PH) and a Higgs-like scalar boson (\PY) in the two bottom quark ($\PH\to\bbbar$) and four quark ($\PY \to \PV\PV \to 4\Pq$) final state in a manuscript recently submitted to \emph{J. High Energy Phys.}~[\mycite{CMS:2026shw}].
...
We have also studied efficient and interpretable algorithms based on transformers for charged particle tracking~[\mycite{Miao:2024oqy}, \mycite{Govil:2025nvy}] and jet tagging~[\mycite{Bhatnagar:2024fkx}, \mycite{Legge:2025cnm}, \mycite{Wang:2025dky}, \mycite{Wang:2026lqb}].
...
Specifically, the Surrogate Neural Architecture Codesign Package (SNAC-Pack)~[\mycite{Weitz:2025dia}] runs a multi-objective parallelized search using a hardware surrogate model, known as \texttt{wa-hls4ml}~[\mycite{Hawks:2025hew}], which outputs per-trial resource and latency estimates, avoiding the synthesis cost that would otherwise dominate the search loop.
