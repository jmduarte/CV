...
Below, I describe my contributions to research, service, and equity, diversity and inclusion, focusing on the most recent review period from July 1, 2024 to June 30, 2026.
...
A version of this algorithm has been adopted in the first CMS search for triple Higgs boson production, which we co-authored and has been submitted to \emph{Phys. Rev. Lett.}~[\mycite{CMS-PAS-HIG-24-012}].
...
\begin{figure}
    ...
    \includegraphics[width=0.37\textwidth]{CMS-HIG-24-012_Figure_001.pdf}
    \caption[SPANet HHH reconstruction and search]{
        ...
        The expected $\PH\PH\PH$ contribution scaled up by a factor of 588 is shown in red.
        \label{fig:hhh}}
\end{figure}
