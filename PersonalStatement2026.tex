...
In addition, we evaluated the performance of the MLPF algorithm in real CMS data and simulation for the first time in a paper submitted to \emph{J. High Energy Phys.}~[\mycite{CMS:2026znb}].
...
Finally, we studied whether the per-particle latent representations of MLPF can be used to improve the performance of downstream tasks, such as jet tagging, and found that they can outperform traditional approaches~[\mycite{Mokhtar:2026gdb}].
...
I recently co-wrote the review of ``Machine Learning'' for the Particle Data Group's 2026 Review of Particle Physics to appear in Int. J. Mod. Phys. A~[\mycite{Duarte:2025qbk}].
