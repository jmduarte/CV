...
\begin{resume}
  ...
  %\noindent S.B. Physics, Massachusetts Institute of Technology \hfill 2010\\
  ...
  \begin{itemize}
    ...
    \item William A. Lee Chancellor's Endowed Junior Faculty Fellow II ({2019--Present})
  ...
  \begin{itemize}
    ...
    \item Studies of quantum machine learning and quantum computation frameworks for high energy physics~\cite{Zlokapa:2019tkn} ({2018--Present}).
  ...
  \begin{itemize}
    ...
    \item Development \texttt{hls4ml} for scientific low-power machine learning devices~\cite{Borras:2022opensource,Banbury:2021mlperf,DiGuglielmo:2021ide,Hawks:2021ruw,Fahim:2021cic} ({2020--Present}).
  ...
  \begin{itemize}
    ...
    \item Particle physics domain mentor for data science capstone \href{https://jmduarte.github.io/capstone-particle-physics-domain}{DSC 180A} ({Fall 2020, Winter 2021, Fall 2021, Winter 2022}).
  ...
  \begin{itemize}
    \itemsep-0.3em
    \item Exhibitor for UC San Diego Physics and Duarte Lab at the \href{https://www.barriologansae.com/}{Barrio Logan Science \& Art Expo} on Saturday, April 16 ({2022}).
  ...
  \begin{itemize}
    \itemsep-0.3em
    \item Mentor for Cal-Bridge program ({2021--2022}).
  ...
  \begin{itemize}
    \itemsep-0.3em
    \item \href{https://theory.fnal.gov/events/event/tbd-137/}{Enabling the Higgs self-coupling measurement with highly energetic Higgs pairs in CMS}. Joint Experimental-Theoretical Physics Seminar (Wine \& Cheese). June 3, 2022. Fermilab, Batavia, IL, USA.
  ...
  \begin{itemize}
    ...
    \item Reviewer for the \href{https://ml4physicalsciences.github.io/2020/}{3rd} and \href{https://ml4physicalsciences.github.io/2021/}{4th} Machine Learning for the Physical Sciences Workshops at Neural Information Processing Systems (NeurIPS) ({2020--2021}).
    \item Scientific organizing committee for \href{https://indico.cern.ch/e/fml2020}{2nd Fast Machine Learning for Science Workshop} at Southern Methodist University ({2020}).
    \item Scientific organizing committee for \href{http://www.ncsa.illinois.edu/Conferences/AcceleratedAINCSA/}{Accelerated Artificial Intelligence for Big-Data Experiments Conference} ({2020}).
    \item UC San Diego Physics Department Graduate Admissions Committee member ({2019--2022}).
          \ifthenelse{\boolean{extended}}{
    \item Local organizing committee for \href{https://indico.cern.ch/e/fml}{Fast ML Workshop} at Fermilab LPC ({2019}).
    \item Local organizing committee for \href{https://indico.cern.ch/e/ml4jets2018}{ML4Jets 2018 Workshop} at Fermilab LPC ({2018}).
  ...
  \begin{itemize}
    ...
    \item Raghav Kansal (UC San Diego). IRIS-HEP fellow, LPC AI fellow. Graph-based generative adversarial networks for particle physics simulation; Search for boosted $\PH\PH\to\PQb\PQb\PW\PW$ ({2019--Present}).
  ...
  \begin{itemize}
    ...
    \item Zichun Hao (UC San Diego). FMP program, Undergraduate Research Award. Lorentz-equivariant generative neural networks and $\PH\to\PW\PW$ tagging ({2021}).
  ...
  \begin{itemize}
    \itemsep-0.3em
    \item \href{https://www.sciencenews.org/article/higgs-boson-particle-physics-standard-model-discovery-anniversary}{How physicists are probing the Higgs boson 10 years after its discovery}
    \item \href{https://mlcommons.org/en/news/mlperf-inference-1q2022/}{MLPerf Results Show Advances in Machine Learning Inference Performance and Efficiency}
    \item \href{https://insidehpc.com/2022/04/mlperf-results-highlight-advances-in-machine-learning-inference-performance-and-efficiency/}{MLPerf Results Highlight Advances in Machine Learning Inference Performance and Efficiency}
    \item \href{https://www.symmetrymagazine.org/article/double-trouble-higgs}{Double trouble Higgs}
    \item \href{https://cerncourier.com/a/graph-neural-networks-boost-di-higgs-search/}{Graph neural networks boost di-Higgs search}
    \item \href{https://ucsdnews.ucsd.edu/pressrelease/physicists-apply-fairness-to-data-studies}{Physicists Apply FAIRness to Data Studies}
    \item \href{https://www.intel.com/content/www/us/en/customer-spotlight/stories/san-diego-supercomputer-customer-story.html}{SDSC Builds AI-Focused ``Voyager'' Supercomputer}
    \item \href{https://cerncourier.com/a/muon-detector-probes-long-lived-particles/}{Muon detector probes long-lived particles}
    \item \href{https://cerncourier.com/a/hunting-anomalies-with-an-ai-trigger/}{Hunting anomalies with an AI trigger}
    \item \href{https://cms.cern/news/new-window-shadow-world-exotic-particle-decays-muon-detectors}{A new window into the shadow world: Exotic particle decays in the muon detectors}
    \item \href{https://ucsdnews.ucsd.edu/pressrelease/physics-computation-experts-help-earn-15m-to-advance-ai-data-analysis}{Physics, Computation Experts Help Earn \$15M to Advance AI, Data Analysis}
    \item \href{https://ucsdnews.ucsd.edu/pressrelease/san-diego-supercomputer-center-teams-up-with-habana-to-power-voyager}{San Diego Supercomputer Center Teams Up with Habana to Power Voyager}
    \item \href{https://cms.cern/news/live-long-and-prosper-searching-long-lived-relatives-higgs-boson}{Live long and propser: Searching for the long-lived relatives of the Higgs boson}
    \item \href{https://cerncourier.com/a/long-lived-particles-gather-interest/}{Long-lived particles gather interest}
    \item \href{https://ucsdnews.ucsd.edu/pressrelease/national-science-foundation-awards-sdsc-5-million-to-develop-innovative-ai-resource}{National Science Foundation Awards SDSC \$5 Million to Develop Innovative AI Resource}
    \item \href{https://cms.cern/news/boosting-unknown-highest-energy-higgs-bosons}{Boosting into the unknown: The highest energy Higgs bosons}
    \item \href{https://physicalsciences.ucsd.edu/media-events/articles/2020/uc-san-diego-physicist-making-a-mark.html}{UC San Diego Physicist Making a Mark}
    \item \href{https://news.fnal.gov/2019/01/fermilab-scientists-help-push-ai-to-unprecedented-speeds/}{Fermilab scientists help push AI to unprecedented speeds}
  \end{itemize}
