...
\textbf{Machine Learning / Coprocessors.} Development of \href{https://github.com/hls-fpga-machine-learning/SonicCMS}{Services for Optimal Network Inference on Coprocessors (SONIC)}~\cite{Duarte:2019fta} (\textit{2018--Present}).
%\begin{itemize}
...
\textbf{Machine Learning / Higgs Tagging.} Development of a mass-decorrelated deep neural network tagger
  for identifiying boosted Higgs bosons decaying to $\bbbar$ and $\ccbar$ in CMS~\cite{CMS-DP-2018-046,Moreno:2019bmu,Moreno:2019neq}
  (\textit{2017--Present}). 
%\begin{itemize} 
