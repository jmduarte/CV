...
\begin{resume}
  ...
  \begin{itemize}
    \itemsep-0.3em
    \item Supervision of students and postdoctoral researchers performing searches for long-lived particles~\cite{CMS-PAS-EXO-22-017,CMS:2024bvl,CMS:2022wjc,CMS:2021yhb,CMS:2021juv} ({2019--Present}).
  ...
  \begin{itemize}
    \itemsep-0.3em
    \item Set- and graph-based neural networks for jet tagging on FPGAs in the level-1 trigger~\ref{Odagiu:2024bkp} (2022--Present).
