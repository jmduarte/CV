...
\textbf{Machine Learning / FAIR4HEP.} Developing frameworks for sharing findable, accessible, interoperable, and reusable (FAIR) data and models in high energy physics~\cite{Chen:2021euv}.

\textbf{Long-lived Particles.} Supervision of student and postdoctoral researchers performing searches for long-lived particles~\cite{CMS-PAS-EXO-20-003,CMS:2021juv} (\textit{2019--Present}).

\textbf{Tiny Machine Learning.} \texttt{hls4ml} for scientific low-power machine learning devices~\cite{Banbury:2021mlperf,DiGuglielmo:2021ide,Fahim:2021cic,Hawks:2021ruw} (\textit{2020--Present}).
