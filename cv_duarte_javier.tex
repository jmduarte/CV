...
\begin{resume}
  ...
  \begin{itemize}
    ...
    \item Author of CMS search for boosted Higgs bosons decaying to two \PW bosons merged in a single jet~\cite{CMS-PAS-HIG-24-008}.
  ...
  \begin{itemize}
    ...
    \item Transformers for highly granular large-radius jet classification~\cite{CMS-PAS-JME-25-001,Li:2024htp} (2023--Present).
