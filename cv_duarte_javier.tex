...
\begin{resume}
  ...
  \textbf{Boosted Double Higgs \& Combination.} Author of CMS search for Lorentz-boosted double Higgs boson production in the four bottom quark final state~\cite{CMS:2022nmn} and CMS statistical combination~\cite{CMS:2022dwd} using full Run 2 data (\textit{2020--Present}).
