...
William A. Lee Chancellor's Endowed Junior Faculty Fellow II Assistant Professor at UC San Diego, La Jolla, CA (\textit{2019--Present})\\
...
\MarginText{Fellowships, Awards, and Grants}
\href{https://science.energy.gov/~/media/78921BDAD1894BBF9A686A2125C3B3C0.ashx}{DOE
  QuantISED} award for ``Quantum Machine Learning and Quantum
  Computation Frameworks for HEP (QMLQCF)'' (\textit{2018--2020})\\
\href{https://ldrd.fnal.gov/subdir/FNAL-LDRD-2019-017-D1.pdf}{Fermilab Laboratory Directed R\&D} award for ``Graph Neural Networks
for Accelerating Calorimetry and Event Reconstruction'' (\textit{2019--2021})\\
\href{https://ldrd.fnal.gov/subdir/FNAL-LDRD-2019-027-D1.pdf}{Fermilab Laboratory Directed R\&D} award for ``Accelerator Control
with Artificial Intelligence'' (\textit{2019--2021})\\
\href{http://lpc.fnal.gov/fellows/2019/Javier_Duarte.shtml}{LHC
  Physics Center Distinguished Researcher} (\textit{2019})\\
\href{http://www.fnal.gov/pub/forphysicists/fellowships/leon_lederman/index.html}{Fermilab
    Lederman Fellowship} (\textit{2016--2019})\\
\href{http://www.pma.caltech.edu/content/france-cordova-graduate-student-fund}{Tombrello
  Scholar} sponsored by the France A. C\'{o}rdova Graduate Student Fund (\textit{2015})\\
\href{https://www.nsfgrfp.org/}{National Science Foundation
  Graduate Research Fellowship} (\textit{2011--2014})\\
%\Description{\textit{2012} \hspace{1.5em} Isidor I. Rabi Award at the
%\href{http://www.emfcsc.infn.it/issp2012/index.html}{International
%School of Subnuclear Physics}}\\
\href{http://www.gmsp.org/}{Gates Millenium
  Scholar} sponsored by Hispanic Scholarship Fund
(\textit{2006--2014})
...
\textbf{Boosted Higgs.} Lead author of search for a highly Lorentz boosted Higgs boson
  decaying to a bottom quark-antiquark pair using 2017 and 2018 data (\textit{2017--Present}).
...
tool for creating low-latency FPGA-based firmware
  implementations of machine learning algorithms~\cite{Duarte:2018ite} (\textit{2017--Present}).
\begin{itemize}
...
\item Developed, trained using simulated data, and
  ...
  masses.
\item Lead a team performing studies in data to commission the neural network.
\item Applied new interaction network~\cite{Moreno:2019bmu} methods to further improve background
  rejection as well as coordinated the release of the simulated data through the CERN Open Data Portal.
\end{itemize}
...
\textbf{Boosted Dijet Resonances.} Co-leader of analysis group searching for exotic, light spin-$1$ and
  ...
  quarks~\cite{Sirunyan:2017nvi,Sirunyan:2018ikr,Sirunyan:2019sgo,CMS-PAS-EXO-18-012} (\textit{2017--2019}).
%\begin{itemize}
...
\textbf{Dijet Resonances.} Co-leader of dijet resonance search group, including data scouting, wide resonance, and $\PQb$-tagged resonance searches~\cite{Sirunyan:2016iap,Sirunyan:2018xlo,CMS-PAS-EXO-17-026,Duarte:2018bsd,CMS-PAS-EXO-19-012,CMS-PAS-EXO-19-004} (\textit{2016--2018}).
%\begin{itemize}
...
\textbf{Trigger.} Testing and commissioning 3D Vertically-Integrated Pattern Recognition
...
%----------------------------------------------------------------------------------------
%\clearpage
\MarginText{Selected Publications}
\vspace{10pt}
...
\MarginText{Teaching and Outreach}
...
\textbf{Physics Teaching.} Lead facilitator of the
...
\textbf{Physics Teaching.} Facilitator for
...
\textbf{Physics Teaching.} Teaching Assistant in statistical and quantum mechanics at Caltech (\textit{2011--2012})
...
\href{https://indico.cern.ch/event/687651/contributions/3428206/}{``Machine
  learning using CERN Open Data.''} 7th Large Hadron Collider Physics Conference. May
...
\href{https://indico.cern.ch/event/687651/contributions/3426898/}{``Dark
  sector searches in CMS.''} 7th Large Hadron Collider Physics Conference. May
  20-25, 2019. Benem\'{e}rita Universidad Aut\'{o}noma de Puebla, Pubela, Mexico.
...
\href{https://indico.cern.ch/event/697988/contributions/3055990/}{``hls4ml:
    ...
    Acquisition.''} Oral presentation. Topical Workshop on Electronics for
...
\href{https://indico.cern.ch/event/615891/contributions/2666361/}{``Search
    for low-mass dijet resonances.''} Oral
  presentation. TeV Particle Astrophysics (TeVPA) 2017. August 7-11,
  2017. Columbus, Ohio, USA.

\href{https://indico.fnal.gov/contributionDisplay.py?sessionId=14&contribId=38&confId=11999}{``Inclusive search for boosted SM Higgs bosons using H to bb decays with the CMS detector at 13 TeV.''} Oral
  presentation. Meeting of the American Physical Society
  Division of Particles and Fields 2017.  July
...
\href{https://indico.fnal.gov/contributionDisplay.py?sessionId=6&contribId=54&confId=13497}{``Introduction
    to CMS open data for boosted object tagging with machine learning applications.''} Oral
  presentation. Data Science at High Energy Physics 2017. May
  8-12, 2017. Fermilab, Batavia, IL, USA.

\href{https://indico.cern.ch/event/540843/contributions/2464658/}{``Dijet
    and boosted dijet searches for low-mass resonances.''} Oral
  presentation. New Physics Interpretations at the LHC 2. April
...
\href{https://indico.cern.ch/event/592671/contributions/2401900/}{``Data
    ...
    resonances.''} Oral
  presentation. Digging Deeper at LHC Run II. February
...
\href{https://indico.cern.ch/event/331032/contributions/1720249/}{``Third
    generation SUSY searches with the CMS detector.''} Oral
  presentation. SUSY 2015. August 23-29, 2015. Lake Tahoe,
  CA, USA.

\href{https://indico.ific.uv.es/indico/contributionDisplay.py?sessionId=24&contribId=289&confId=2025}{``Inclusive
    SUSY searches at CMS.''} Oral presentation. 37th International
  Conference of High Energy Physics. July 2-9, 2014. Valencia
  Conference Centre, Valencia, Spain.

\href{https://indico.cern.ch/event/279518/contributions/634785/}{``Search
    for SUSY with the razor variables at CMS.''} Poster
  presentation. 2nd Large Hadron Collider Physics Conference. June
  2-7, 2014. Columbia University, New York, NY, USA.

\href{https://indico.cern.ch/event/252857/contributions/1579321/}{``Searches
    for Supersymmetry with the CMS Detector.''} Oral presentation. 2nd
...
\href{https://indico.cern.ch/event/261650/contributions/586374/}{``Razor
    Search for SUSY in CMS at $\sqrt{s}=8$ TeV.''} Oral presentation. Kinematic Variables for
  New Physics at the LHC. October 4-6, 2013. Caltech, Pasadena, CA, USA.

\href{https://indico.cern.ch/event/218693/contributions/1520333/}{``BSM Likelihoods in CMS.''} Oral presentation. Likelihoods for
...
\MarginText{Committee Work}

Local organizing committee for
  \href{https://indico.cern.ch/e/fml}{Fast ML} workshop
  at Fermilab LPC

Local organizing committee for
  \href{https://indico.cern.ch/e/ml4jets2018}{ML4Jets 2018} workshop
  at Fermilab LPC

\href{http://diversity.fnal.gov/target/}{TARGET}
  program committee at Fermilab (\textit{2017--2019})

\href{http://lpc.fnal.gov/programs/topic/}{LPC Topic of the Week}
  committee chair at Fermilab (\textit{2017--2018})

Analysis Review Committee for four CMS analyses: a \href{http://arxiv.org/abs/1803.08030}{search for new
  physics with dijet angular distributions}, \href{https://arxiv.org/abs/1803.06986}{a search for fully hadronic
  $\ttbar\PH(\bbbar)$}, a search for strongly interacting massive
particles, and a search for electroweak production of a vector-like
top quark partner in the fully-hadronic final state.

Local organizing committee for
  \href{http://dshep.fnal.gov}{DS@HEP 2017} workshop at Fermilab and
  development of public data set based on CMS open data for boosted
  object tagging with machine learning applications

Local organizing committee for
  \href{https://indico.cern.ch/event/639314/}{LHC Reinterpretation 2017} workshop at Fermilab LPC
...
\item Sydney Jenknins (University of Chicago). Compression and
  firmware implementation of interaction and graph neural networks for charged particle tracking at the LHC (\textit{2018}).
