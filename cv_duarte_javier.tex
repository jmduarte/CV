...
\begin{resume}
  ...
  \begin{itemize}
    ...
    \item Author of CMS searches for boosted Higgs boson pair production in the four bottom quark final state~\cite{CMS:2022nmn}, all-hadronic $\bbbar\PV\PV$ final state~\cite{CMS-PAS-HIG-23-012,CMS-PAS-B2G-23-007}, and CMS statistical combination of Higgs boson pair searches~\cite{CMS-PAS-HIG-20-011,CMS:2022dwd} using full Run 2 data ({2020--Present}).
  ...
  \begin{itemize}
    ...
    \item Self-supervised learning strategies for foundation models in high energy physics~\cite{Zhao:2024kry,Li:2024htp,Katel:2024ygn} (2023--Present).
  ...
  \begin{itemize}
    ...
    \item Efficient and interpretable transformers for charged particle tracking~\cite{Miao:2024oqy} and jet tagging~\cite{Bhatnagar:2024fkx} (2023--Present).
