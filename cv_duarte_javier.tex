...
\begin{resume}
  ...
  \begin{itemize}
    ...
    \item Co-author of CMS search for triple Higgs boson production in the six bottom quark final state~\cite{CMS-PAS-HIG-24-012} and contributor to first $\PH\PH\PH$ white paper~\cite{Brigljevic:2024vuv}.
  ...
  \begin{itemize}
    ...
    \item Five Year Ad Hoc Review Committee for Marisa Abrajano, Provost, Earl Warren College (2026).
