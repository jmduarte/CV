...
\textbf{Machine Learning / Sparse Data Generation.} Supervision of students developing generative adversarial networks and autoencoders for fast spaese data generation in high energy physics~\cite{Kansal:2020svm} (\textit{2019--Present}).
...
\textbf{Machine Learning / Coprocessors.} Development of \href{https://github.com/hls-fpga-machine-learning/SonicCMS}{Services for Optimal Network Inference on Coprocessors (SONIC)}~\cite{Rankin:2020usv,Krupa:2020bwg,neurips2019_sonic,Duarte:2019fta} (\textit{2018--Present}).
%\begin{itemize}
...
tool for creating low-latency FPGA-based firmware
  implementations of machine learning algorithms~\cite{Iiyama:2020wap,DiGuglielmo:2020eqx,Summers:2020xiy,neurips2019_hls4ml,Duarte:2018ite} (\textit{2017--Present}).
%\begin{itemize}
...
Level-1 trigger~\cite{CERN-LHCC-2020-004} (\emph{2017--Present}).
%\begin{itemize}
...
\textbf{Timing Detector.} Measurements of the timing properties of
  ...
  resolution of approximately 30\unit{ps} is achievable~\cite{Bornheim:2017gql,8069874,Anderson:2016tiu,Anderson:2016ygg,7581887,Anderson:2015gha,Anderson:2015tia,Bornheim_2015}
  (\textit{2014--2016}).
...
\textbf{Undergraduate Seminar.} Organizer of Physics 191:
Undergraduate Seminar on Physics (Fall \textit{2020})
...
Scientific organizing committee for \href{https://indico.cern.ch/e/fml2020}{Fast Machine Learning for Science Workshop} at SMU (\textit{2020})
