...
\begin{resume}
  ...
  \begin{itemize}
    ...
    \item Author of CMS search for boosted double Higgs boson production in the four bottom quark final state~\cite{CMS:2022nmn} and CMS statistical combination of Higgs boson pair searches~\cite{CMS-PAS-HIG-20-011,CMS:2022dwd} using full Run 2 data ({2020--Present}).
  ...
  \begin{itemize}
    ...
    \item Development of \href{https://github.com/fastmachinelearning/SonicCMS}{Services for Optimal Network Inference on Coprocessors (SONIC)}~\cite{Zhao:2025daw,CMS:2024twn,CMS-DP-2023-037,Krupa:2020bwg,Rankin:2020usv,neurips2019_sonic,Duarte:2019fta} ({2018--Present}).
