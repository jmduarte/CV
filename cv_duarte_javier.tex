...
\href{https://science.osti.gov/-/media/early-career/pdf/FY20_DOE_SC_Early_Career_Research_Program_Abstracts.pdf}{Office of Undergraduate Research Outstanding Mentor Award} (\textit{2021})\\
...
\textbf{Long-lived Particles.} Supervision of student and postdoctoral researchers performing searches for long-lived particles~\cite{CMS-PAS-EXO-20-003,CMS-PAS-EXO-20-015} (\textit{2019--Present}).

\textbf{Tiny Machine Learning.} \texttt{hls4ml} for scientific low-power machine learning devices~\cite{DiGuglielmo:2021ide,Fahim:2021cic,Hawks:2021ruw} (\textit{2020--Present}).
...
\textbf{Machine Learning / Generation.} Supervision of students developing generative adversarial networks and autoencoders for fast sparse data generation in high energy physics~\cite{Kansal:2020svm} (\textit{2019--Present}).
