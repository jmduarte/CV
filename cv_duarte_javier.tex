...
\begin{resume}
  ...
  \begin{itemize}
    ...
    \item Neural architecture codesign~\cite{Weitz:2025dia,Weitz:2025tcj,McDermott:2023neural} and surrogate models for fast resource esimtation~\cite{Hawks:2025hew} (2023--Present).
    \item Efficient and interpretable transformers for charged particle tracking~\cite{Govil:2025nvy,Miao:2024oqy} and jet tagging~\cite{Wang:2026lqb,Legge:2025cnm,Wang:2025dky,Bhatnagar:2024fkx} (2023--Present).
