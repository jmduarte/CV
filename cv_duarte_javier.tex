...
\begin{resume}
  ...
  \begin{itemize}
    \itemsep-0.3em
    \item Supervision of students and postdoctoral researchers performing searches for long-lived particles~\cite{CMS-PAS-EXO-22-017,CMS:2022wjc,CMS:2021yhb,CMS:2021juv} ({2019--Present}).
  ...
  \begin{itemize}
    ...
    \item Development of frameworks for sharing findable, accessible, interoperable, and reusable (FAIR) data and models in high energy physics~\cite{Huerta:2022kgj,Duarte:2022job,Chen:2021euv} ({2020--Present}).
  ...
  \begin{itemize}
    ...
    \item Development of \href{https://github.com/fastmachinelearning/SonicCMS}{Services for Optimal Network Inference on Coprocessors (SONIC)}~\cite{CMS-PAS-MLG-23-001,CMS-DP-2023-037,Krupa:2020bwg,Rankin:2020usv,neurips2019_sonic,Duarte:2019fta} ({2018--Present}).
  ...
  \begin{itemize}
    \itemsep-0.3em
    \item Creator of a \href{HEPCAT Lab Module on ML/AI on FPGAs}{https://hepcat.ucsd.edu/summer-schools/fast-ml-fpga-lab/} (Summer 2023).
  ...
  \begin{itemize}
    ...
    \item \href{https://rescorp.org/cottrell-scholars/cottrell-scholars-conference}{Building a better foundation: Teaching physicists and machines to how to learn from data}. Cottrell Scholar Conference. July 19, 2023. Tucson, AZ, USA.
  ...
  \begin{itemize}
    ...
    \item Organizer of {https://indico.cern.ch/e/hdrpostbac2023}{NSF HDR Postbaccalaureate Workshop} at UC San Diego (2023).
