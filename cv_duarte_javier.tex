...
\begin{resume}
  ...
  \begin{itemize}
    ...
    \item Author of CMS searches for boosted Higgs boson pair production in the four bottom quark final state~\cite{CMS-PAS-HIG-24-010,CMS:2022nmn}, all-hadronic $\bbbar\PV\PV$ final state~\cite{CMS-PAS-HIG-23-012,CMS-PAS-B2G-23-007}, and CMS statistical combination of Higgs boson pair searches~\cite{CMS:2025ngq,CMS:2022dwd} using full Run 2 data ({2020--Present}).
