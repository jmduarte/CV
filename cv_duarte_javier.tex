...
\begin{resume}
  ...
  \begin{itemize}
    \itemsep-0.3em
    \item Co-PI of DOE Award \href{https://science.osti.gov/-/media/funding/pdf/Awards-Lists/2026/GM-RFA-Awards-List.pdf}{AIDA-Scout: AI for Inclusive Real-Time Anomaly Detection and Accelerated Discovery in the CMS Level-1 Scouting System} (2026--2027).
  ...
  \begin{itemize}
    ...
    \item Instructor for Physics 142/242: Computational Physics II: PDE and Matrix Models ({Winter 2025, Winter 2024, Spring 2022}).
  \end{itemize}
  ...
  \begin{itemize}
    ...
    \item Ph.D. Thesis Committee for Robert Lee (UC San Diego) (2023--Present).
