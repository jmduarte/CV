...
\textbf{Tiny Machine Learning} \texttt{hls4ml} for scientific low-power machine learning devices~\cite{fahim2021hlsml} (\textit{2020--Present}).
...
\textbf{Mentoring.} US CMS Mentor to Daniel Fernando Guerrero Ibarra (University of Florida) (\textit{2020--2021}).
...
Referee for Journal of High Energy Physics (\textit{2020}).
