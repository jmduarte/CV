...
\begin{resume}
  ...
  \textbf{Snowmass 2021.} Contributor to the Snowmass 2021 Community Planning Exercise, including studies for machine learning for double Higgs production~\cite{Diaz:2022sgo}, and co-convenor of CompF4 subgroup on AI Hardware.

  \textbf{Boosted Double Higgs.} Author of CMS search for Lorentz-boosted double Higgs boson production in the four bottom quark final state using full Run 2 data~\cite{CMS-PAS-B2G-22-003} (\textit{2020--Present}).
