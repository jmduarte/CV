...
\textbf{Boosted Double Higgs.} Author of CMS search for Lorentz-boosted double Higgs boson production in the four bottom quark final state using full Run 2 data (\textit{2020--Present}).
...
\textbf{Machine Learning / Reconstruction.} Graph neural networks~\cite{Duarte:2020ngm} for particle-flow reconstruction~\cite{CMS-DP-2021-030,Pata:2021oez}, including explainable AI techniques~\cite{Mokhtar:2021bkf}, and charged particle tracking~\cite{Elabd:2021lgo,Dezoort:2021kfk,Heintz:2020soy} (\textit{2019--Present}).
...
\textbf{Machine Learning / Anomly Detection.} Development of anomaly detection algorithms for new physics searches~\cite{Tsan:2021brw,Govorkova:2021utb,Aarrestad:2021oeb,Kasieczka:2021xcg,Wozniak:2020} (\textit{2019--Present}).
