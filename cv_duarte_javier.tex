...
\begin{resume}
  ...
  \begin{itemize}
    ...
    \item Neural architecture codesign~\cite{McDermott:2023neural,Weitz:2025tcj} and surrogate models for fast resource esimtation~\cite{Hawks:2025hew} (2023--Present).
