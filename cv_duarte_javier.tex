...
\textbf{Machine Learning / Particle-flow Reconstruction.} Graph neural networks for particle-flow reconstruction~\cite{Pata:2021oez,Duarte:2020ngm} (\textit{2019--Present}).

\textbf{Machine Learning / Sparse Data Generation.} Supervision of students developing generative adversarial networks and autoencoders for fast sparse data generation in high energy physics~\cite{Kansal:2020svm} (\textit{2019--Present}).

\textbf{Machine Learning / Anomly Detection for New Physics.} Development of anomaly detection algorithms for new physics searches in jet final states~\cite{Kasieczka:2021xcg,Wozniak:2020} (\textit{2019--Present}).
...
\textbf{Graduate Seminar.} Guest speaker for Physics 261: Seminar on Physics Research at UC San Diego (Winter \textit{2021})

\textbf{Research for Undergraduates.} Instructor for Physics 199:  Research for Undergraduates for 3 students (Winter \textit{2021})

\textbf{Introductory Physics.} Lead instructor for Physics 2C: Fluids, Waves, Thermodynamics, and Optics for 300 undergraduate students (Winter \textit{2021})

\textbf{Special Subjects in Physics.} Guest speaker for \href{https://github.com/violatingcp/MIT_8.S50}{MIT 8.S50}: Computational Data Science in Physics (Winter \textit{2021})
...
\href{https://indico.cern.ch/event/615891/contributions/2666361/}{``Search
    for low-mass dijet resonances.''} TeVPA 2017. August 7-11, 2017. Columbus, OH, USA.
...
\href{https://indico.fnal.gov/contributionDisplay.py?sessionId=6&contribId=54&confId=13497}{``Introduction to CMS open data for boosted object tagging with machine learning applications.''} Data Science at High Energy Physics 2017. May 8-12, 2017. Fermilab, Batavia, IL, USA.
...
Guest Associate Editor for \href{https://www.frontiersin.org/research-topics/19095/efficient-ai-in-particle-physics-and-astrophysics}{``Efficient AI in Particle Physics and Astrophysics''} Research Topic in \emph{Front. Big Data} and \emph{Front. AI} (\textit{2021})

Journal of High Energy Physics (\emph{J. High Energy Phys.}) peer reviewer (\textit{2020})

Equity, Diversity, and Inclusion Committee member for UC San Diego Physics Department (\textit{2020--2021}).
...
Graduate Admissions Committee member for UC San Diego Physics Department (\textit{2019--2021})

European Physics Journal C (\emph{Eur. Phys. J. C}) peer reviewer (\textit{2019--2020})

European Science Foundation (ESF) external reviewer (\textit{2018--2020})
...
\MarginText{Supervision}

Supervision of Postdoctoral Researchers (\textit{2021--Present}).
