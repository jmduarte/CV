...
\textbf{Machine Learning / Particle-flow Reconstruction.} Graph neural networks for particle-flow reconstruction~\cite{Pata:2021mlpf,Duarte:2020ngm} (\textit{2019--Present}).
...
\textbf{Machine Learning / Anomly Detection for New Physics.} Development of anomaly detection algorithms for new physics searches in jet final states~\cite{Kasieczka:2021lhc,Wozniak:2020} (\textit{2019--Present}).
