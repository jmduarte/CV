...
\renewbibmacro*{begentry}{\ifkeyword{citation}{\makebox[0pt][r]{\textasteriskcentered\addspace}}{}}
...
\begin{resume}
  ...
  \begin{itemize}
    \itemsep-0.3em
    \item \href{https://breakthroughprize.org/Laureates/1/L3994}{Breakthrough Prize in Fundamental Physics} (awarded to co-authors of CERN LHC Run-2 publications at ATLAS, CMS, ALICE, and LHCb) (2025)
    \item American Physical Society \href{https://www.aps.org/programs/honors/prizes/prizerecipient.cfm?last_nm=Duarte&first_nm=Javier&year=2024}{Henry Primakoff Award for Early-Career Particle Physics} (2024)
    \item UCSD \href{https://blink.ucsd.edu/HR/policies/affirmative/awards/#2022-Recipients-}{Inclusive Excellence Award} (2023)
    ...
    \item UCSD Undergraduate Research Hub \href{https://ugresearch.ucsd.edu/research-mentors/outstanding-mentor-awards/urh-mentor-award/index.html#2021}{Outstanding Mentor Award} ({2021})
  ...
  \MarginText{Grants and Funding}
  \begin{itemize}
    \itemsep-0.3em
    \item Co-PI of DOE Award \href{https://pamspublic.science.energy.gov/webPAMSExternal/Interface/Common/ViewPublicAbstract.aspx?rv=13e3fcd3-f9ea-441e-ac06-32397ff74d5b&rtc=24}{AIDA-Scout: AI for Inclusive Real-Time Anomaly Detection and Accelerated Discovery in the CMS Level-1 Scouting System} (2026--2027).
    \item UCSD Academic Senate Research Grant for Transforming Higgs pair production searches at the LHC (2025--2026).
    \item Key Personnel for DOE Award \href{https://pamspublic.science.energy.gov/WebPAMSExternal/Interface/Common/ViewPublicAbstract.aspx?rv=2af52921-6271-4d62-bec1-3e7b28c4fcbe&rtc=24&PRoleId=10}{UCSD Experimental and Theoretical Particle Physics} (2024--2028).
    \item Co-PI of \href{https://www.nsf.gov/awardsearch/showAward?AWD_ID=2425206&HistoricalAwards=false}{PREP: Advancing Research and Education in AI/ML for Science (AREAS)} (2024--2027).
    \item Lead PI of RCSA Cottrell Scholars Collaborative \href{hiddenfigs.github.io}{Hidden Figures in Physics and Astonomy} ({2023--2025}).
  ...
  \MarginText{Most Significant Scientific Contributions}

  \begin{itemize}
    \item Led some of the first high-$\pt$ Higgs boson searches at the LHC~\cite{CMS:2022nmn,Sirunyan:2017dgc}.
    \item Development of \href{https://github.com/fastmachinelearning/hls4ml}{\texttt{hls4ml}}~\cite{Schulte:2025mai,Duarte:2018ite}, which has garnered over 2000 GitHub stars and over 800 citations, for AI-enabled trigger and data acquisition systems.
    \item Creation of the first ML algorithm for particle-flow reconstruction~\cite{Pata:2021oez} deployed in real data~\cite{CMS:2026znb} and one of the first graph neural networks for jet tagging~\cite{Moreno:2019bmu,Moreno:2019neq}.
    \item Studies of foundation models for high energy physics~\cite{Mokhtar:2026gdb,Mokhtar:2025zqs,Li:2024htp,Zhao:2024kry}.
    \item First graph neural network for generative modeling in high energy physics~\cite{Kansal:2021cqp} published in NeurIPS.
    \item Deployment of the first anomaly detection level-1 trigger at the LHC~\cite{CMS-PAS-MLG-25-001,CMS-DP-2025-061,CMS-DP-2024-059,,CMS-DP-2023-079,Govorkova:2021utb}.
  \end{itemize}
  ...
  \begin{itemize}
    \itemsep-0.3em
    \item Co-convener of CMS Higgs $\bbbar$/$\ccbar$ subgroup ({2025--2027}).
    \item Co-author of CMS search for triple Higgs boson production in the six bottom quark final state~\cite{CMS:2026xkc} and contributor to first $\PH\PH\PH$ white paper~\cite{Brigljevic:2024vuv}.
    \item Author of CMS search for boosted Higgs bosons decaying to two \PW bosons merged in a single jet~\cite{CMS:2026yrb}.
    \item Author of CMS searches for boosted Higgs boson pair production in the four bottom quark final state~\cite{CMS:2026znu,CMS:2022nmn}, all-hadronic $\bbbar\PV\PV$ final state~\cite{CMS:2026shw,CMS-PAS-HIG-23-012}, and CMS statistical combination of Higgs boson pair searches~\cite{CMS:2025ngq,CMS:2022dwd} using full Run 2 data ({2020--Present}).
  ...
  \begin{itemize}
    \itemsep-0.3em
    \item Supervision of students and postdoctoral researchers performing searches for long-lived particles~\cite{CMS:2025rtd,CMS:2024zqs,CMS:2024ake,CMS:2024bvl,CMS:2022wjc,CMS:2021yhb,CMS:2021juv} ({2019--Present}).
    ...
    \item Co-leader of dijet resonance search group, including data scouting, wide resonance, and $\PQb$-tagged resonance searches~\cite{CMS:2024zhe,Sirunyan:2019pnb,Sirunyan:2019vgj,CMS-PAS-EXO-17-026,Duarte:2018bsd,Sirunyan:2018xlo,Sirunyan:2016iap} ({2016--2018}).
  \end{itemize}

  \textbf{Novel Machine Learning Algorithms for Physics}
  \begin{itemize}
    \itemsep-0.3em
    \item Particle Data Group author responsible for review on machine learning~\cite{Duarte:2025qbk} (2024--Present).
    \item Transformers for highly granular large-radius jet classification~\cite{CMS:2026uph,Li:2024htp} (2023--Present).
    \item Symmetry-preserving attention networks for boosted and resolved multi-Higgs-boson event reconstruction~\cite{Li:2024qfq} (2022--Present).
    \item Co-author of reviews and book chapters on machine learning for high energy physics~\cite{Duarte:2024xkc,Chien:2024gnn,Duarte:2024lsg,Duarte:2022efficient,Deiana:2021niw,Duarte:2020ngm} (2020--Present).
    \item Symbolic regression to find parametric functions to model binned distributions in high energy physics~\cite{Tsoi:2024pbn} (2024--Present).
    \item Co-convener of CMS Machine Learning Group ({2023--2025}).
    \item Self-supervised learning strategies for foundation models in high energy physics~\cite{Hao:2025abk,Zhao:2024kry,Katel:2024ygn} (2023--Present).
    ...
    \item Development of anomaly detection algorithms for new physics searches~\cite{CMS-DP-2025-061,CMS-DP-2024-059,CMS-DP-2023-079,Hao:2022zns,Govorkova:2021utb,Jawahar:2021vyu,Aarrestad:2021oeb,Tsan:2021brw,Kasieczka:2021xcg,Wozniak:2020} ({2019--Present}).
    \item Development of graph neural networks~\cite{Chien:2024gnn,Duarte:2020ngm} and transformers for particle-flow reconstruction~\cite{Mokhtar:2026gdb,CMS:2026znb,CMS-DP-2025-033,Mokhtar:2025zqs,Pata:2023rhh,Mokhtar:2023fzl,CMS-DP-2022-061,Pata:2022wam,CMS-DP-2021-030,Pata:2021oez}, including explainable AI techniques~\cite{Mokhtar:2022pwm,Mokhtar:2021bkf}, and charged particle tracking~\cite{Huang:2023bny,Elabd:2021lgo,Dezoort:2021kfk,Heintz:2020soy} ({2019--Present}).
  ...
  \begin{itemize}
    \itemsep-0.3em
    \item Supervision of students developing efficient and fault-tolerant edge neural networks~\cite{Weng:2025amigolut,Baldi:2024reliable,Weng:2024fkeras,Weng:2023tailor} (2023--Present).
    \item Neural architecture codesign~\cite{Weitz:2026xsv,Weitz:2025dia,Weitz:2025tcj,McDermott:2023neural} and surrogate models for fast resource esimtation~\cite{Hawks:2025hew} (2023--Present).
    \item Efficient and interpretable transformers for charged particle tracking~\cite{Miao:2026yvl,Govil:2025nvy,Miao:2024oqy} and jet tagging~\cite{Wang:2026lqb,Legge:2025cnm,Wang:2025dky,Bhatnagar:2024fkx} (2023--Present).
    ...
    \item Tools for quantization-aware training~\cite{Campos:2023pkp,Hawks:2021ruw} (2021--Present).
    \item Real-time AI on FPGAs for accelerator control~\cite{John:2020sak} ({2018--2021}).
    \item Development of \href{https://fastmachinelearning.org/SuperSONIC/}{Services for Optimal Network Inference on Coprocessors (SONIC)}~\cite{Kondratyev:2025jfj,Zhao:2025daw,CMS:2024twn,CMS-DP-2023-037,Krupa:2020bwg,Rankin:2020usv,neurips2019_sonic,Duarte:2019fta} ({2018--Present}).
    \item Creation and development of \href{https://fastmachinelearning.org/hls4ml/}{\texttt{hls4ml}} tool for low-latency, low-power machine learning algorithms on FPGAs and ASICs~\cite{Gonski:2026jgu,Schulte:2025mai,Hussain:2022faststamp,Borras:2022opensource,Banbury:2021mlperf,DiGuglielmo:2021ide,Fahim:2021cic,Deiana:2021niw,Elabd:2021lgo,Govorkova:2021utb,Iiyama:2020wap,Heintz:2020soy,DiGuglielmo:2020eqx,Summers:2020xiy,neurips2019_hls4ml,Duarte:2018ite} ({2017--Present}).
  ...
  %	PUBLICATIONS
  %----------------------------------------------------------------------------------------
  \MarginText{Selected Publications, Reviews, Reports, Book Chapters, and Conference Proceedings}
  Selected publications, reviews, reports, book chapters, and conference proceedings to which I made a substantial contribution are listed here.
  My most highly cited articles according to Google Scholar are denoted with an asterisk (*).
  My h-index according to Google Scholar is 245.
  % to add all career keys
  \nocite{*}
  ...
  \begin{itemize}
    \itemsep-0.3em
    \item Instructor for Physics 105A: Mathematical \& Computational Physics I (Winter 2026).
    \item Instructor for Physics 141/241: Computational Physics I: Probabilistic Models and Simulations ({Spring 2023, Winter 2022}).
    \item Instructor for Physics 142/242: Computational Physics II: PDE and Matrix Models ({Fall 2026, Winter 2025, Winter 2024, Spring 2022}).
  \end{itemize}

  \textbf{Machine Learning \& Data Science}
  \begin{itemize}
    \itemsep-0.3em
    \item Creator of and instructor for \href{https://jduarte.physics.ucsd.edu/phys139_239}{Physics 139/239: Machine Learning in Physics} ({Fall 2025, Spring 2024, Winter 2023}).
  ...
  \begin{itemize}
    \itemsep-0.3em
    \item Lecturer at \href{https://indico.fnal.gov/event/71907/}{Fermilab-CERN Hadron Collider Physics Summer School} (Summer 2026).
  ...
  \begin{itemize}
    \itemsep-0.3em
    \item Lead instructor for \href{https://jduarte.physics.ucsd.edu/phys2c/index.html}{Physics 2C}: Fluids, Waves, Thermodynamics, and Optics for 300+ undergraduate students ({Winter 2020, Winter 2021, Spring 2021, Spring 2026}).
  ...
  \begin{itemize}
    ...
    \item UC San Diego Physics representative for the Mentoring Project (2024--Present).
    ...
    \item US CMS Collaboration Diversity, Equity, and Inclusion Committee ({2022--2024}).
  ...
  \begin{itemize}
    \itemsep-0.3em
    \item \href{https://indico.fnal.gov/event/71907/timetable/#35-higgs-measurements}{Higgs Measurements}. Fermilab-CERN Hadron Collider Physics Summer School. August 13--14, 2026. Fermilab, Batavia, IL, USA.
    \item \href{https://ceci.ucr.edu/cwods2026}{From Event Reconstruction to Foundation Models for Collider Physics}. CECI Workshop on Detector Science (CWODS). July 2, 2026. UC Riverside, Riverside, CA, USA.
    \item \href{https://sair.foundation/events/science-ai-summit-2026-uc-riverside}{AI in Detector Design and Operation Panel Discussion}. Science x AI Summit. June 29, 2026. UC Riverside, Riverside, CA, USA.
    \item \href{https://physics.ucsd.edu/events/seminars-colloquia/event?event_id=2493}{LLM meets Physics Panel Discussion}. Physics Colloquium. March 5, 2026. UC San Diego, La Jolla, CA, USA.
    \item \href{https://ci-compass.org/news-and-events/events/virtual-workshop-ai-meets-ci-intelligent-infrastructure-for-major-and-midscale-facilities/}{Searching for new physics at the energy and intelligence frontiers}. NSF CI Compass Virtual Workshop. AI Meets CI: Intelligent Infrastructure for Major \& Midscale Facilities. January 12, 2026.
    \item \href{https://indico.cern.ch/event/1526677/contributions/6591856/}{Progress on AI-based jet tagging}. Machine Learning for Jets (ML4Jets) 2025. August 18, 2025. Caltech, Pasadena, CA, USA.
    \item \href{https://indico.cern.ch/event/1555253/contributions/6651428/}{Machine Learning Topics in A3D3}. A3D3 All-Hands Meeting. August 16, 2025. Caltech, Pasadena, CA, USA.
    \item \href{https://indico.phys.hawaii.edu/event/2506/contributions/7774/}{hls4ml and friends: Tools for ML in trigger and DAQ}. ML4FE Workshop. May 19, 2025. University of Hawaii, Honolulu, HI, USA.
    \item \href{https://www.caltech.edu/campus-life-events/calendar/physics-colloquium-85}{From collisions to discoveries with machine learning at the energy frontier}. Physics Colloquium. January 30, 2025. Caltech, Pasadena, CA, USA.
    ...
    \item \href{https://indico.cern.ch/event/745718/contributions/3211982/}{Heavy flavour identification for boosted resonances and large cone jets in CMS}. Machine Learning for Jets (ML4Jets) 2018. November 14--16, 2018. Fermilab, Batavia, IL, USA.
  ...
  \begin{itemize}
    \item Ph.D. Thesis Committee for Siqi Miao (Georgia Tech) (2026--Present).
    \item Ph.D. Thesis Committee for Anna Tifrea (UC San Diego) (2026--Present).
    \item Ph.D. Thesis Committee for Dhruba Ghosh (Virginia Tech) (2026--Present).
    \item Ph.D. Thesis Committee for Aneesh Baburaj (UC San Diego) (2025).
    \item Ph.D. Thesis Committee (Chair) for Zihan Zhao (UC San Diego) (2024--Present).
    \item Ph.D. Thesis Committee for Wyatt Joyce (UC San Diego) (2024--Present).
    \item Ph.D. Thesis Committee (Co-Chair) for Luke Fairbanks (UC San Diego) (2024--Present).
    \item Ph.D. Thesis Committee (Chair) for Daniel Primosch (UC San Diego) (2024--Present).
    \item Ph.D. Thesis Committee for Michael Pokornik (UC San Diego) (2024--Present).
    \item Ph.D. Thesis Committee for Olivia Weng (UC San Diego) (2024--2026).
    \item Ph.D. Thesis Committee for Qingyuan Chen (UC San Diego) (2023--Present).
    \item M.S. Thesis Committee (Chair) for Steven Tsan (UC San Diego) (2023--2024).
    \item Ph.D. Thesis Committee for Robert Lee (UC San Diego) (2023--2026).
    \item Ph.D. Thesis Committee (Chair) for Anthony Aportela (UC San Diego) (2023--Present).
    \item Ph.D. Thesis Committee (Chair) for Farouk Mokhtar (UC San Diego) (2023--2026).
    \item Ph.D. Thesis Committee for Yifan Xiang (UC San Diego) (2023--2024).
    \item M.S. Thesis Committee for Kyle Yang (UC San Diego) ({2022}).
    \item Ph.D. Thesis Committee for Yueqi Zhao (UC San Diego) (2023--Present).
    \item Ph.D. Thesis Committee (Chair) for Raghav Kansal (UC San Diego) ({2022--2024}).
    \item M.S. Thesis Committee for Paul Wang (UC San Diego) ({2021}).
    \item Ph.D. Thesis Committee for Christian Aganze (UC San Diego) ({2021--2023}).
  \end{itemize}

  \textbf{Other Service}
  \begin{itemize}
    \itemsep-0.3em
    \item CMS AI Strategy Group (2026).
    \item US Muon Collider Collaboration Meeting Program Committee (2026).
    \item APS Division of Particles and Fields (DPF) Meeting Energy Frontier Track Convener (2026).
    \item Reviewer for the International Conference on Machine Learning (2026).
    \item Reviewer for the International Conference on Learning Representations (2026).
    \item School of Physical Sciences Data Science for the Physical Sciences Task Force (2025--Present).
    \item DOE-HEP Energy Frontier University Comparative Review Panel (2025).
    \item San Diego Faculty Association Executive Board Member (2025--2027).
    ...
    \item Scientific organizing committee for \href{https://indico.cern.ch/e/fml2020}{2nd}, \href{https://indico.cern.ch/e/fml2022}{3rd}, \href{https://indico.cern.ch/e/fastml2023}{4th}, \href{https://indico.cern.ch/e/fastml2024}{5th}, \href{https://indi.to/fastml25}{6th}, and \href{https://indi.to/fastml26}{7th} Fast Machine Learning for Science Conferences and \href{http://www.ncsa.illinois.edu/Conferences/AcceleratedAINCSA/}{Accelerated Artificial Intelligence for Big-Data Experiments Conference}({2020--Present}).
    ...
    \item Reviewer for the Neural Information Processing Systems (NeurIPS) Conference (2023, 2025, 2026).
    ...
    \item Referee for \emph{Physical Review Letters}, \emph{Physical Review D}, \emph{Physical Review X}, \emph{Physical Review Research}, \emph{Journal of High Energy Physics}, \emph{Physics Letters B}, \emph{European Physics Journal C}, \emph{Machine Learning: Science and Technology}, \emph{Computing and Software for Big Science}, \emph{Applied Optics}, \emph{Nuclear Instruments and Methods in Physics Research Section A}, and \emph{Science Bulletin} ({2019--Present}).
    \item US CMS Advisory Board (2022--2024).
    ...
    \item UC San Diego Physics Department Graduate Admissions Committee member ({2019--2022}, 2025--2026).
          \ifthenelse{\boolean{extended}}{
  ...
  \begin{itemize}
    \itemsep-0.3em
    \item Ellison Scheuller (UC San Diego). WATCHEP fellow. Anomaly detection for CMS level-1 trigger (2025--Present).
    \item Jason Weitz (UC San Diego). WATCHEP fellow. Neural architecture codesign (2024--Present).
    ...
    \item Russell Marroquin Solares (UC San Diego). WATCHEP fellow. CMS level-1 trigger long-lived particle tagger ({2022--Present}).
    ...
    \item Raghav Kansal (UC San Diego). IRIS-HEP fellow, LPC AI fellow, LPC graduate scholar. Graph-based generative adversarial networks for particle physics simulation; Search for boosted $\PH\PH\to\bbbar\PW\PW$ ({2019--2024}).
  ...
  \begin{itemize}
    \itemsep-0.3em
    \item Vivekanand Sahu (UC San Diego). Efficient particle transformer (2023--Present).
    \item Priyansh Bhatnagar (UC San Diego). Efficient transformers for particle physics (2023--2024).
    \item Rounak Sen (UC San Diego). Discretized GANs for particle physics (2023--2024).
    \item Prashant Krishnan Vaidyanathan (UC San Diego). Self-supervised learning for particle physics (2023--2024).
    \item Steven Tsan (UC San Diego). Diffusion models for particle physics (2022--2024).
    ...
    \item Akbota Assan (UC San Diego). ML-based particle-flow reconstruction for muon collider data (2026--Present).
  \end{itemize}

  \textbf{Postbaccalaureate Students}
  \begin{itemize}
    \item Luke McDermott (UC San Diego). Neural architecture codesign (2023--2024).
  ...
  \begin{itemize}
    \itemsep-0.3em
    \item Tanya Sinha (UC San Diego). ML-based particle-flow reconstruction for muon collider data (2026--Present).
    \item Cindy Dong (UC San Diego). ML for LLP muon detector showers (2026--Present).
    \item Mathias Pretet (UC San Diego). Efficient particle transformers for jet tagging (2026--Present).
    \item Alan Xia (UC San Diego). Efficient particle transformers for jet tagging (2025--Present).
    \item Haris Zia (UC San Diego). Efficient particle transformers for jet tagging (2025--Present).
    \item Trevin Lee (UC San Diego). LLP identification, SONIC, and MoE particle transformers (2024--2026).
    \item Timothy Legge (UC San Diego). Particle transformers for jet tagging interpretability (2025--Present).
    ...
    \item Peera Serumaga (UC San Diego).  Symmetry-preserving attention networks for semi-merged top quarks (2024--2026).
    \item Adolfo Partida (UC San Diego). Symmetry-preserving attention networks for semi-merged top quarks (2024--2025).
    \item Julian Jackson (UC San Diego). Symmetry-preserving attention networks for semi-merged top quarks (2024--2025).
    \item Chang Liu (UC San Diego). Long-lived particle searches in CMS (2024--2025).
    \item Shuyang Zhang (UC San Diego). Long-lived particle searches in CMS (2023--2025).
    \item Jason Weitz (UC San Diego). Neural architecture codesign (2023--2024).
    \item Dmitri Demler (UC San Diego). Neural architecture codesign (2023--2025).
    \item Emily Pan (UC San Diego). GNNS for identifying long-lived particles (2023--2025).
    \item Aditya Sriram (UC San Diego). GNNS for identifying long-lived particles (2023--2024).
    ...
    \item Rohan Sachdeva (UC San Diego). Anomaly detection for CMS level-1 trigger (2023--2025).
    \item Jet Yue (UC San Diego). ABCD neural network for background estimation in CMS. ({2023--2026}).
    ...
    \item Mengke Zhang (UC San Diego). Undergraduate Research Award. Machine-learned particle-flow for the Compact Linear Collider ({2022--2025}).
    ...
    \item Simon Poon (UC San Diego). FMP program. Machine-learned missing transverse momentum for CMS level-1 trigger ({2021--2024}).
    \item Sukanya Krishna (UC San Diego). IRIS-HEP fellow. Real-time anomaly detection for jets ({2021--2023}).
    ...
    \item Rushil Roy (UC San Diego). FMP program. tinyML with \texttt{hls4ml} ({2021--2023}).
  ...
  \begin{itemize}
    \itemsep-0.3em
    \item \href{https://today.ucsd.edu/story/genesis-mission-to-fund-new-scientific-ai-tools}{``UC San Diego Receives Department of Energy Genesis Mission Award to Fund New Scientific AI Tools''}, UC San Diego Today, August 21, 2026
    \item \href{https://beyondstandard.org/articles/particle-physicists-are-quietly-redefining-the-frontier-of-ultra-fast-ai/}{``Particle physicists are quietly redefining the frontier of ultra-fast AI''}, Beyond Standard, August 3, 2026
    \item \href{https://ep-news.web.cern.ch/content/particle-flow-learned-reconstruction-cms}{``From particle flow to learned reconstruction at CMS''}, CERN EP Newsletter, March 25, 2026
    \item \href{https://home.cern/news/news/physics/machine-learning-reveal-more-about-lhc-particle-collisions}{``Machine learning to reveal more about LHC particle collisions''}, CERN Homepage, February 18, 2026
    \item \href{https://cms.cern/news/teaching-cms-trace-particles}{``Teaching CMS to trace particles''}, CMS Physics Briefing, February 12, 2026
    \item \href{https://spectrum.ieee.org/particle-physics-ai}{``AI hunts for the next big thing in physics''} by Matthew Hutson, IEEE Spectrum, February 3, 2026
    \item \href{https://cms.cern/news/tale-two-higgs-quest-production-higgs-boson-pairs-cms}{``A tale of two Higgs: The quest for production of Higgs boson pairs at CMS''}, CMS Physics Briefing, December 4, 2024
    \item \href{https://cms.cern/news/transforming-landscape-highly-energetic-higgs-boson-searches}{``Transforming the landscape of highly energetic Higgs boson searches''}, CMS Physics Briefing, July 28, 2024
  ...
  %My most highly cited articles according to Google Scholar are relisted here.
  %My h-index according to Google Scholar is 245.
